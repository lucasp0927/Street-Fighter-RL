...
#DRAW = False
ll = Learner(6,9,0.0001,memory_pool_size = 100000,exp_epoch=7000,epsilon_rate = 0.0005,momentum=0.3,learner_type="DDQN",n_hidden1 = 50, n_hidden2 = 50,freeze_interval=20,train_interval=100)
WINDOWWIDTH = 400
WINDOWHEIGHT = 300
LINETHICKNESS = 10
PADDLESIZE = 75
